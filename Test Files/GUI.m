cfunction varargout = GUI(varargin)
...
% Last Modified by GUIDE v2.5 06-Nov-2017 21:51:30
...
% Hint: get(hObject,'Value') returns toggle state of DG
...
% Hint: get(hObject,'Value') returns toggle state of CA1
