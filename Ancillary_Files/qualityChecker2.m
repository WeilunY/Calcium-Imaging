function [ ]=qualityChecker( imageRef, stack, maskStructure, maskStack )
...
file = '20180302_PiloMouse0A_005';
load([file,' motionCut_Output','.mat']);
% cutfromStack
% frameCorrStatus
% stackAdjustedCut
load([file,' segOutput','.mat']);
% imageCN      Ref image matrix
% intavg
% intavgNP
% intavgNPCorr
% maskStructInt
